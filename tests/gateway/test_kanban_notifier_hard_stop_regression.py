...
The respawn_guarded event is NOT in TERMINAL_KINDS (Phase A was
reverted) — only the blocked event is claimed and rendered.
"""
...
def test_hard_stop_sends_exactly_one_notification(tmp_path, monkeypatch):
    ...
    This is the regression gate for the Phase A revert. If this test fails
    (2 messages), the duplicate has reappeared.
    """
    ...
    # Must NOT be the old Phase A message
